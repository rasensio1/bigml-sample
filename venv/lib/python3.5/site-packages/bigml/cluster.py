...
class Cluster(ModelFields):
    ...
    def summarize(self, out=sys.stdout):
        ...
        """
        out.write("Cluster of %s centroids\n\n" % len(self.centroids))
        ...
        out.write("Data distance statistics:\n\n")
        for centroid in centroids_list:
            centroid.print_statistics(out=out)

        if len(self.centroids) > 1:
            out.write("Intercentroids distance:\n\n")
            for centroid in centroids_list:
                out.write(utf8("To centroid: %s\n" % centroid.name))
                for measure, result in self.centroids_distance(centroid):
