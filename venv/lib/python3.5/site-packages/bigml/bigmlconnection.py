        ...
        if error_info is not None and 'code' in error_info:
            ...
            if code == HTTP_NOT_FOUND and method == 'get':
                ...
                error += (
                    ...
                    ' id. The most probable causes are:\n\n%s'
                    '- A typo in the %s\'s id.\n'
                    '- The %s id cannot be accessed with your credentials.\n'
                    '- The resource was created in a mode (development or'
                    ' production) that is not the one set in the'
                    ' BigML connection object by the corresponding flag.\n'
